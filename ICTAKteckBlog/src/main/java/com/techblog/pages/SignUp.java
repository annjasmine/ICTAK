...
public class SignUp {
    ...
    //Trainer
		    ...
		    @FindBy(xpath="/html/body/app-root/app-signup/form/small[5]/b/text()[1]]")
    ...
    PageFactory.initElements(driver, this);
		    ...
		    public boolean clickSubmitUser1(){ 
				return  submituser.isEnabled();
		    }
		    ...
		    public boolean clickSubmitTrainer1(){ 
				return  submittrainer.isEnabled();
		    }
